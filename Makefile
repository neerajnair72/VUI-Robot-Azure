...
test_Windows_10_chrome_103:
	robot --variable version:103 --variable platformName:'Windows 10' --variable smartUI.project:'Boston Whaler' --variable browserName:Chrome --variable isRealMobile:false --variable visual:false --variable network:false --variable w3c:true --variable console:false --outputdir Results/Windows11/Edge 'rf-tests/Find A Dealer.robot'
